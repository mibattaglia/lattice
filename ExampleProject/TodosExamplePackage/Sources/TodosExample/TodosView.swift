...
struct TodosView: View {
    @Bindable private var viewModel: ViewModel<TodosEvent, TodosDomainState, TodosViewState>

    init(viewModel: ViewModel<TodosEvent, TodosDomainState, TodosViewState>) {
